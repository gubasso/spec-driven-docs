...
rule_ids! {
    ...
    CompatibilityAdaptersMatchUpstream => "simple-english:compatibility-adapters-match-upstream",
    ObjectiveCheckMatchesItsUpstreamRule => "simple-english:an-objective-check-matches-its-upstream-rule",
    ExceptionNamesItsReason => "simple-english:an-exception-names-its-reason",
    MarketingCopyStaysOutOfScope => "simple-english:marketing-copy-stays-out-of-scope",
    PlainIsTheDefault => "simple-english:plain-is-the-default",
    ProtectedContentStaysExact => "simple-english:protected-content-stays-exact",
    StrictIsExplicit => "simple-english:strict-is-explicit",
    StructureSuppliesThePassageMode => "simple-english:structure-supplies-the-passage-mode",
    SimpleEnglishDependencyIsAvailableOffline => "simple-english:the-dependency-is-available-offline",
    UpstreamPatternIsBinding => "simple-english:the-upstream-pattern-is-binding",
    UpstreamTermsKeepTheirNames => "simple-english:upstream-terms-keep-their-names",
