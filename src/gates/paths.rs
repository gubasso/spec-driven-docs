...
//!
//! One of these locations is declared rather than fixed: the docs scratch.
//! It is recorded in the manifest and named by one environment variable,
//! and the variable wins where it is set.
//!
...
use crate::domain::manifest::{DOCS_SCRATCH_VAR, MANIFEST_PATH};
