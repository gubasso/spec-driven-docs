...
The subject anchors the reader's eye at the left edge where scanning starts. Holding it fixed across tables lets the alternatives rotate by theme without the reader relearning the layout.
