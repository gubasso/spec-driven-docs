...
Please report a suspected vulnerability through [this project's private vulnerability reporting form](https://github.com/gubasso/spec-driven-docs/security/advisories/new). Sign in to GitHub to use the form. This channel is available for public repositories after private reporting is enabled. If it is unavailable, contact a maintainer through an existing private conversation before sending sensitive details.
