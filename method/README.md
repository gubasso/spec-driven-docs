...
Start with [the model](./00-model.md), use [placement](./01-placement.md) to choose a home, then follow the chapter that owns the artifact being changed. [The checklist](./99-checklist.md) is the pre-merge review surface.
