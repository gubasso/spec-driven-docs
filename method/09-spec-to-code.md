...
The third command prints the agreed rules no work enacted: the spec-first backlog, computed from two record sets and stored in neither. The same shape run against code prints the opposite defect.
