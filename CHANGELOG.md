...
- *(self-depend)* Keep a consumer's pin fresh from this tool

## [0.11.0](https://github.com/gubasso/spec-driven-docs/compare/v0.10.2...v0.11.0) - 2026-09-15

### Other

- *(instance)* [**breaking**] Carry no plan zone

## [0.10.2](https://github.com/gubasso/spec-driven-docs/compare/v0.10.1...v0.10.2) - 2026-09-14

### Fixed

- *(release)* Hold the support boundary where each half can be held ([#101](https://github.com/gubasso/spec-driven-docs/pull/101))

## [0.10.1](https://github.com/gubasso/spec-driven-docs/compare/v0.10.0...v0.10.1) - 2026-09-14

### Fixed

- *(distribution/install)* Install for the machine, not for one terminal ([#102](https://github.com/gubasso/spec-driven-docs/pull/102))
